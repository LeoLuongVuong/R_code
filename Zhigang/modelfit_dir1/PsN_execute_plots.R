...
#Created 2024-04-15 at 15:58

xpose.runno <- '1'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/vsc-hard-mounts/leuven-data/357/vsc35700/Fluco_revised/R_code/Zhigang/modelfit_dir1/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/vsc-hard-mounts/leuven-apps/rocky8/icelake/2021a/software/PsN/5.3.0-foss-2021a/lib/perl5/site_perl/5.32.1/PsN_5_3_0/R-scripts' # This is not used
raw.results.file <- 'raw_results_1.csv'
theta.labels <- c('1 F','2 KA','3 CL','4 V1','5 PROP ERROR','6 ADDI ERROR')
theta.fixed <- c(FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)
omega.labels <- c('1. omF1','2. omKA','3. omCL','5. omV1')
